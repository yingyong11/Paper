...
### Files
1. src/ 
    1. [scrapping&processing_data](./src/scrapping&processing_data.ipynb) : Code that scrapes freight indexes for each website, transforms indexes into a standardized form, and saves it as a csv files
