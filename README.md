...
* Pandas
  * It is used to convert index data scraped by websites into a data frame.
...
### Files
1. src/ 
    1. [scraping&processing_data](./src/scrapping&processing_data.ipynb) : Code that scrapes freight indexes for each website, transforms table of indexes data into a standardized form, and saves it as a CSV files
